...
(function (scenes) {
    var Riddle = (function (_super) {
        ...
        Riddle.prototype.start = function () {
            ...
            this._westButton = new objects.Button("West", config.Screen.CENTER_X - 100, config.Screen.CENTER_Y + 100);
            this.addChild(this._westButton);
            this._westButton.on("click", this._westButtonClick, this);
            this._eastButton = new objects.Button("East", config.Screen.CENTER_X - 100, config.Screen.CENTER_Y + 100);
